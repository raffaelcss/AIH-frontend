    ...
    <OpenContext.Provider value={open}>
      ...
      >
        <div className="flex flex-auto flex-col ">
          <a className="mb-8 flex flex-none cursor-pointer text-slate-500 md:px-2 ">
        ...
        <div className="mt-2 flex flex-none flex-col text-slate-500 dark:text-gray-100 ">
          <LightModeSwitch />
          <a className="flex h-10 cursor-pointer items-center rounded hover:bg-indigo-100 hover:dark:bg-slate-500 md:px-2">
